...
SuSiE <- R6Class("SuSiE",
  ...
  active = list(
    ...
    pip_history = function() lapply(2:length(private$.pip_history), function(i) private$.pip_history[[i]]),
    lbf_history = function() lapply(2:length(private$.lbf_history), function(i) private$.lbf_history[[i]]),
