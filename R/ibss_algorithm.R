    ...
    fit = function(d, prior_weights=NULL, estimate_prior_variance_method=NULL, check_null_threshold=0, verbose=TRUE) {
        ...
        for (i in 1:private$.niter) {
            ...
            for (l in 1:private$L) {
                ...
                private$SER[[l]]$fit(d, prior_weights=prior_weights, estimate_prior_variance_method=estimate_prior_variance_method, check_null_threshold=check_null_threshold)
