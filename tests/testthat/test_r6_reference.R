...
# ============================================================================
# R=1/R=3 matrix prior and R=3 mash K=1 basic tests
# (moved to test_numerical_sweep.R which covers all est_pv × est_rv ×
#  method × intercept combinations comprehensively)
# ============================================================================
